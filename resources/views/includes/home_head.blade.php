    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto" style="margin: auto">
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('app.home') }}" style="color:white">Home <span
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="{{ route('user.realEstate') }}" style="color:black">Real Estate</a>
                    <a class="dropdown-item" href="{{ route('user.cryptoMarket') }}" style="color:black">Crypto
                        Market</a>
                    <a class="dropdown-item" href="{{ route('user.stocks') }}" style="color:black">Stocks
                        Investments</a>
                    <a class="dropdown-item" href="{{ route('user.medHedgeFunds') }}" style="color:black">Medical
                        Hedgefunds</a>
                    <a class="dropdown-item" href="{{ route('user.techStartup') }}" style="color:black">Tech Startup
                        Investments</a>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{ route('user.login') }}" style="color:white">
                  {{ $loggedInUser !== null ? 'Dashboard' : 'Login' }}
                </a>
            </li>
            <li class="nav-item">
