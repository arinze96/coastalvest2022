    ...
    <div id="main-wrapper">
        ...
        <div class="featured_slick_gallery gray">
            <div class="featured_slick_gallery-slide">
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg62.webp') }}"
                    class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg62.webp') }}"
                        class="img-fluid mx-auto" alt="" /></a>
            </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg63.webp') }}"
                    class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg63.webp') }}"
                        class="img-fluid mx-auto" alt="" /></a>
            </div>
         
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg64.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg64.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg65.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg65.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg66.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg66.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg67.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg67.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
            </div>
