        ...
        <div class="clearfix"></div>
           ...
           <div class="featured_slick_gallery gray">
            <div class="featured_slick_gallery-slide">
                ...
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg6.webp') }}"
                    class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg6.webp') }}"
                        class="img-fluid mx-auto" alt="" /></a>
            </div>
         
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg10.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg10.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg5.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg5.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg3.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg3.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/omg9.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/omg9.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12">
                        ...
                        <div class="property_block_wrap style-2 p-4">
                            <div class="prt-detail-title-desc">
                                ...
                                <h3 style="margin-bottom: 10px">Banyon Tree Realty</h3>
                                <span style="margin-bottom: 10px"><i class="lni-map-marker"></i>210 Zirak Road, Canada</span>
