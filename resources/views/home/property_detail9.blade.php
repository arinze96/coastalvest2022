    ...
    <div id="main-wrapper">
        ...
        <div class="featured_slick_gallery gray">
            <div class="featured_slick_gallery-slide">
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg77.webp') }}"
                    class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg77.webp') }}"
                        class="img-fluid mx-auto" alt="" /></a>
            </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg78.webp') }}"
                    class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg78.webp') }}"
                        class="img-fluid mx-auto" alt="" /></a>
            </div>
         
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg79.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg79.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg80.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg80.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg81.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg81.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg82.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg82.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
            </div>
