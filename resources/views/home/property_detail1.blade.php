    ...
    <div id="main-wrapper">
        ...
        <div class="featured_slick_gallery gray">
            <div class="featured_slick_gallery-slide">
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg17.webp') }}"
                    class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg17.webp') }}"
                        class="img-fluid mx-auto" alt="" /></a>
            </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg12.webp') }}"
                    class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg12.webp') }}"
                        class="img-fluid mx-auto" alt="" /></a>
            </div>
         
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg13.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg13.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/omg14.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/omg14.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg15.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg15.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg16.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg16.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12">
                        ...
                        <div class="property_block_wrap style-2 p-4">
                            <div class="prt-detail-title-desc">
                                ...
                                <h3 style="margin-bottom: 10px">Blue Reef Properties</h3>
                                <span style="margin-bottom: 10px"><i class="lni-map-marker"></i>9572 Trusel Ave.
                                    VA</span>
                                <h3 class="prt-price-fix" style="margin-top: 10px">$17,600/month</h3>
