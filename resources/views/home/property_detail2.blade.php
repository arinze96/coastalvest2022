    ...
    <div id="main-wrapper">
        ...
        <div class="featured_slick_gallery gray">
            <div class="featured_slick_gallery-slide">
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg18.webp') }}"
                    class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg18.webp') }}"
                        class="img-fluid mx-auto" alt="" /></a>
            </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg19.webp') }}"
                    class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg19.webp') }}"
                        class="img-fluid mx-auto" alt="" /></a>
            </div>
         
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg20.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg20.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg21.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg21.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg22.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg22.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg23.webp') }}"
                        class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg23.webp') }}"
                            class="img-fluid mx-auto" alt="" /></a>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12">
                        ...
                        <div class="property_block_wrap style-2 p-4">
                            <div class="prt-detail-title-desc">
                                ...
                                <h3 style="margin-bottom: 10px">Beacon Homes LLC</h3>
                                <span style="margin-bottom: 10px"><i class="lni-map-marker"></i>77 Magnolia
                                    Anaheim, CA</span>
                                <h3 class="prt-price-fix" style="margin-top: 10px">$9,200/month</h3>
