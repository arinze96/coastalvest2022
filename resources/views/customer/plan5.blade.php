        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">TECH STARTUP PLANS</div>
                    <div class="ps-3">
                    ...
                    @if (!$plans->isEmpty())
                        <div class="row">
                            ...
                            @foreach ($plans as $key => $plan)
                                {{-- <?php if ($plan->type == "Tech Startups") {
                                    continue;
                                } ?> --}}
                                <div class="col-12 col-sm-8 col-md-6 col-lg-3" id="plans4"
                                    style="display: block">
                        ...
                        <span>Total Return Swap</span>
                                        ...
                                        <div class="card-footer border-top-0">
                                            <button style="background-color: #006849"; disabled="true" data-key="{{ $key }}"
