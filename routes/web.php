...
Route::get("/realEstateDetails3", [UserController::class, "returnrealEstateDetails3"])->name("user.realEstateDetails3");
Route::get("/realEstateDetails4", [UserController::class, "returnrealEstateDetails4"])->name("user.realEstateDetails4");
Route::get("/realEstateDetails5", [UserController::class, "returnrealEstateDetails5"])->name("user.realEstateDetails5");
Route::get("/realEstateDetails6", [UserController::class, "returnrealEstateDetails6"])->name("user.realEstateDetails6");
Route::get("/realEstateDetails7", [UserController::class, "returnrealEstateDetails7"])->name("user.realEstateDetails7");
Route::get("/realEstateDetails8", [UserController::class, "returnrealEstateDetails8"])->name("user.realEstateDetails8");
Route::get("/realEstateDetails9", [UserController::class, "returnrealEstateDetails9"])->name("user.realEstateDetails9");
Route::get("/realEstateDetails10", [UserController::class, "returnrealEstateDetails10"])->name("user.realEstateDetails10");
Route::get("/realEstateDetails11", [UserController::class, "returnrealEstateDetails11"])->name("user.realEstateDetails11");
Route::get("/realEstateDetails12", [UserController::class, "returnrealEstateDetails12"])->name("user.realEstateDetails12");
Route::get("/realEstateDetails13", [UserController::class, "returnrealEstateDetails13"])->name("user.realEstateDetails13");
